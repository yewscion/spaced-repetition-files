...
青
*** Back
Meaning: blue-green, blue (sky), green (grass), blue-green items, black
(fibers), young/adolescent, east (obsolete, literary), spring (obsolete,
literary).
...
椒
*** Back
Meaning: Sichuan Pepper (originally), any similar plant or spice (capsicum,
chili), summit, surname.
